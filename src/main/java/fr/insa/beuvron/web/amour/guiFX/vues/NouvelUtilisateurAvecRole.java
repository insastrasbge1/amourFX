 ...
 * @author francois
 */
public class NouvelUtilisateurAvecRole extends GridPane {
    ...
    public NouvelUtilisateurAvecRole(VuePrincipale main) {
        this.main = main;
        ...
        this.vbValidate.setOnAction((event) -> {
            ...
            try {
                ...
                if (r == null) {
                    JavaFXUtils.showErrorInAlert("Vous devez selectionner un role");
                } else {
        ...
        lig ++;
        this.add(new Label("role : "), 0, lig);
        this.add(this.cRole, 1, lig);
        lig ++;
